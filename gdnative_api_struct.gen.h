...
typedef struct godot_gdnative_ext_xr_api_struct {
	...
	void (*godot_xr_set_interface)(godot_object *p_xr_interface, const godot_xr_interface_gdnative *p_gdn_interface);
	void (*godot_xr_blit_layer)(void *p_blit_to_screen, const godot_rid *p_render_target, const godot_rect2 *p_src_rect, const godot_rect2 *p_dest_rect, godot_int p_layer);
	bool (*godot_xr_get_vulkan_data)(godot_xr_vulkan_data *p_vulkan_data);
	bool (*godot_xr_get_image_data)(const godot_rid *p_vulkan_data, uint64_t *p_texture_id, uint32_t *p_format);
	godot_real_t (*godot_xr_get_worldscale)();
	godot_transform3d (*godot_xr_get_reference_frame)();
	...
	void (*godot_xr_set_controller_transform)(godot_int p_controller_id, godot_transform3d *p_transform, godot_bool p_tracks_orientation, godot_bool p_tracks_position);
	void (*godot_xr_set_controller_button)(godot_int p_controller_id, godot_int p_button, godot_bool p_is_pressed);
	void (*godot_xr_set_controller_axis)(godot_int p_controller_id, godot_int p_exis, godot_real_t p_value, godot_bool p_can_be_negative);
	godot_real_t (*godot_xr_get_controller_rumble)(godot_int p_controller_id);
...
typedef struct godot_gdnative_ext_text_api_struct {
	...
	void (*godot_packed_glyph_array_reverse)(godot_packed_glyph_array *p_self);
...
typedef struct godot_gdnative_core_api_struct {
	...
	void (*godot_variant_new_quaternion)(godot_variant *r_dest, const godot_quaternion *p_quaternion);
	...
	void (*godot_variant_new_transform3d)(godot_variant *r_dest, const godot_transform3d *p_trans);
	...
	godot_quaternion (*godot_variant_as_quaternion)(const godot_variant *p_self);
	godot_aabb (*godot_variant_as_aabb)(const godot_variant *p_self);
	godot_basis (*godot_variant_as_basis)(const godot_variant *p_self);
	godot_transform3d (*godot_variant_as_transform3d)(const godot_variant *p_self);
	...
	void (*godot_variant_call_with_cstring)(godot_variant *p_self, const char *p_method, const godot_variant **p_args, const godot_int p_argument_count, godot_variant *r_return, godot_variant_call_error *r_error);
	...
	void (*godot_variant_set_named)(godot_variant *p_self, const godot_string_name *p_key, const godot_variant *p_value, bool *r_valid);
	void (*godot_variant_set_named_with_cstring)(godot_variant *p_self, const char *p_key, const godot_variant *p_value, bool *r_valid);
	...
	godot_variant (*godot_variant_get_named_with_cstring)(const godot_variant *p_self, const char *p_key, bool *r_valid);
	...
	bool (*godot_variant_is_builtin_method_static)(godot_variant_type p_type, const godot_string_name *p_method);
	bool (*godot_variant_is_builtin_method_static_with_cstring)(godot_variant_type p_type, const char *p_method);
	...
	void (*godot_aabb_new_copy)(godot_aabb *r_dest, const godot_aabb *p_src);
	...
	void (*godot_basis_new_copy)(godot_basis *r_dest, const godot_basis *p_src);
	...
	void (*godot_color_new_copy)(godot_color *r_dest, const godot_color *p_src);
	...
	void (*godot_packed_vector2i_array_new_copy)(godot_packed_vector2i_array *r_dest, const godot_packed_vector2i_array *p_src);
	...
	void (*godot_packed_vector3i_array_new_copy)(godot_packed_vector3i_array *r_dest, const godot_packed_vector3i_array *p_src);
	...
	void (*godot_plane_new_copy)(godot_plane *r_dest, const godot_plane *p_src);
	void (*godot_quaternion_new)(godot_quaternion *p_self);
	void (*godot_quaternion_new_copy)(godot_quaternion *r_dest, const godot_quaternion *p_src);
	godot_real_t *(*godot_quaternion_operator_index)(godot_quaternion *p_self, godot_int p_index);
	const godot_real_t *(*godot_quaternion_operator_index_const)(const godot_quaternion *p_self, godot_int p_index);
	void (*godot_rect2_new)(godot_rect2 *p_self);
	void (*godot_rect2_new_copy)(godot_rect2 *r_dest, const godot_rect2 *p_src);
	void (*godot_rect2i_new)(godot_rect2i *p_self);
	void (*godot_rect2i_new_copy)(godot_rect2i *r_dest, const godot_rect2i *p_src);
	void (*godot_rid_new)(godot_rid *p_self);
	void (*godot_rid_new_copy)(godot_rid *r_dest, const godot_rid *p_src);
	...
	const char *(*godot_string_to_latin1_chars)(const godot_string *p_self);
	const char *(*godot_string_to_utf8_chars)(const godot_string *p_self);
	const char16_t *(*godot_string_to_utf16_chars)(const godot_string *p_self);
	const char32_t *(*godot_string_to_utf32_chars)(const godot_string *p_self);
	const wchar_t *(*godot_string_to_wide_chars)(const godot_string *p_self);
	char32_t *(*godot_string_operator_index)(godot_string *p_self, godot_int p_index);
	const char32_t *(*godot_string_operator_index_const)(const godot_string *p_self, godot_int p_index);
	...
	void (*godot_transform3d_new)(godot_transform3d *r_dest);
	void (*godot_transform3d_new_copy)(godot_transform3d *r_dest, const godot_transform3d *p_src);
	void (*godot_transform2d_new)(godot_transform2d *r_dest);
	void (*godot_transform2d_new_copy)(godot_transform2d *r_dest, const godot_transform2d *p_src);
	...
	void (*godot_vector2_new_copy)(godot_vector2 *r_dest, const godot_vector2 *p_src);
	...
	void (*godot_vector2i_new_copy)(godot_vector2i *r_dest, const godot_vector2i *p_src);
	...
	void (*godot_vector3_new_copy)(godot_vector3 *r_dest, const godot_vector3 *p_src);
	...
	void (*godot_vector3i_new_copy)(godot_vector3i *r_dest, const godot_vector3i *p_src);
